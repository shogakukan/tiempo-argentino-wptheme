    ...
    <div class="d-flex col-12 flex-column flex-lg-row p-0">
        <div class="col-12 col-lg-8 p-0">
                ...
                <div class="container">
                    <div class="text-left mx-auto">
                            ...
                            <div class="pl-lg-5">
                                ...
                                <div class="d-flex justify-content-between align-items-end mt-3">
                                    <?php if ($show_date && $date) : ?>
                                        <time class="date mb-0" datetime="<?php echo $article->get_date_day('Y-m-d H:s'); ?>"><?php echo $date; ?></time>
                                    <?php endif; ?>
                            ...
                            <?php elseif ($thumbnail) : ?>
                                <div class="img-container mt-3">
                                    <div class="img-wrapper" id="article-main-image">
                                        <img
                                            src="<?php echo esc_attr($thumbnail_chico['url']); ?>"
                                            alt="<?php echo  $thumbnail['alt'] ? esc_attr($thumbnail['alt']) : $article->title; ?>"
                                            width="767"
                                            height="511"
                                            loading="eager"
                                            decoding="sync"
                                            ...
                                            srcset="
                                                <?php echo esc_attr($thumbnail_mobile['url']); ?> 500w,
                        ...
                        <footer class="my-5">
                            ...
                            ?>
                            <div class="container-md mb-2 p-0 text-right">
            ...
            <?php if (is_active_sidebar('article_desktop_calltoaction')) : ?>
                <aside class="row d-none d-sm-none d-md-flex d-lg-flex mt-md-3 mb-md-3 mt-3">
                    <div class="col-12 mx-auto">
