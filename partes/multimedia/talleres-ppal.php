<div class="talleres mt-3">
    <div class="container-with-header py-3">
        <div class="container">
            <div class="section-title">
                <h4>TALLERES TIEMPO</h4>
            </div>
        </div>
                ...
                <div class="col-12 col-md-4 text-left mt-3 mt-md-0">
                    ...
                    <div class="d-flex flex-row align-items-start">
                        ...
                        <div class="d-flex flex-column justify-items-center">
                            <p class="type taller m-0">Talleres Tiempo</p>
                            <p class="author m-0">Por: Nombre Autor</p>
                        </div>
                    </div>
                    <div class="taller-info mt-4">
                        <p><span>Días:</span> Martes 9, 16 y 23 de Febrero</p>
                        <p><span>Horario:</span> de 20 hs a 22 hs</p>
                        <p><span>Valor:</span> $1000</p>
