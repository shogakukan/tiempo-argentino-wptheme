                            ...
                            <div class="address-block">
                                <div class="form-container mt-4">
                                    ...
                                    <div class="btns-container text-center mt-4">
                                        <button class="yellow-btn-white-text" id="pagoExitosoBtn">enviar datos</button>
                                    </div>
                                </div>
...
<div class="popup-container" id="pagoExitoso">
        ...
        <div class="popup">
            <div class="container text-center">
                ...
                <div class="popup-content">
                    ...
                    <div class="subtitle">
                        <p><b>Tu pago se ha concretado con éxito.</b></p>
                    </div>
                    <div class="img-container mt-3">
                        <img src="../../assets/images/successicon.svg" alt="" class="img-fluid mx-auto">
                    </div>
                    <div class="ayuda text-center mt-4 mb-3">
                        <h6 class="mt-2">Recuerda que podrás <b>suspender el abono mensual</b> en cualquier momento
                            desde tu
                            perfil de usuario.</h6>
                    </div>
